...
def main(args):
    ...
    dataset_train, args.nb_classes = build_dataset(is_train=True, args=args, is_multisize=args.is_multisize)
    dataset_val, _ = build_dataset(is_train=False, args=args, is_multisize=args.is_multisize)
    ...
    # model is created, xavier initialized. (except patchembed(nothing), cls token & distill token & posembed (trunc normal), biases(0))
